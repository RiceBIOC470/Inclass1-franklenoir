...
%the period, each cell is being multiplied against each corresponding cell

%explain this command:
m2./m1
%Each cell is being divided against each corresponding cell

%extra credit: explain why this command gives a warning:
m2/m1

%determinant is 0, and inverse of matrix doesn't exist. 
